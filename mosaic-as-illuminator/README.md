Mosaic As Illuminator
=====================

Runs the Mosaic with two different ROIs, the "Image Region" which allows you
to image using the Mosaic as a light source to expose a limited field of view.

The second ROI would be the "Bleach Region" which is the area that will be
triggered at the bleach step.  The Mosaic As Illuminator experiment is
designed to be used in MDA.
